...
public class SellerMainPageActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent searchResultIntent = new Intent(SellerMainPageActivity.this, SearchResultActivity.class);
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.seller_drawer_layout);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_order_list) {
            Intent orderListIntent = new Intent(SellerMainPageActivity.this, OrderListActivity.class);
            startActivity(orderListIntent);
        } else if (id == R.id.nav_product_qna) {
            Intent productQnaIntent = new Intent(SellerMainPageActivity.this, ProductQnaActivity.class);
            startActivity(productQnaIntent);
        } else if (id == R.id.nav_seller_page) {
            Intent orderListIntent = new Intent(SellerMainPageActivity.this, SaleProductListActivity.class);
            startActivity(orderListIntent);
        }
